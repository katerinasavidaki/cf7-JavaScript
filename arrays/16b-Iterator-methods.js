...
const isOutOfStock = cart.some(item => item.stock === 0)   // true αν κάποιο απο τα stock = 0
const isAllOutOfStock = cart.every(item => item.stock === 0)    // true αν όλα είναι stock = 0
